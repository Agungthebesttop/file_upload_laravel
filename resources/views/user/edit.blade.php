                ...
                <div class="card-body">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <img src="{{asset( 'storage/' . auth()->user()->avatar) }}" alt="gambar"  height="200">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <!-- @if (Route::has('avatar.request'))
                                    <a class="btn btn-link" href="{{ route('avatar.request') }}">
                                        {{ __('Forgot Your avatar?') }}
                                    </a>
                                @endif -->
                            </div>
                        </div>
